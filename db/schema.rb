...
ActiveRecord::Schema.define(version: 20160728054813) do
  ...
  create_table "sprites", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.text     "content",    limit: 65535
    t.integer  "word_id"
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.index ["word_id"], name: "index_sprites_on_word_id", using: :btree
  end
